...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VoteNow=(TextView)findViewById(R.id.votenowtv);
        Voted=(TextView)findViewById(R.id.votedtv);

        ref.child("Users").child(Phone).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(isVote.equals("1"))
                {
                    ...
                    VoteNow.setVisibility(View.INVISIBLE);
